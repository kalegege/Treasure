...
<head>
    ...
    <script type="text/javascript" src="js/dingding/zepto.min.js"></script>
    <script type="text/javascript" src="http://g.alicdn.com/dingding/open-develop/1.6.9/dingtalk.js">
    </script>
    <script type="text/javascript" src="js/dingding/logger.js">
    </script>
    // 免登相关代码
    <script type="text/javascript" src="js/dingding/demo.js">
